define([
  ...
  var GlossaryItemView = Backbone.View.extend({
    ...
    className: "m-glossary__item",

    events: {
      'click .js-glossary-item': 'onGlossaryItemClicked'
    },
    ...
    showGlossaryItemDescription: function() {
      var $glossaryItemTerm = this.$('.js-glossary-item');
    ...
    hideGlossaryItemDescription: function() {
      ...
      this.$('.js-glossary-item').removeClass('is-selected').attr('aria-expanded', false);
    },
